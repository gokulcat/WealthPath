...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-fixed" style={{ backgroundImage: `url(${WW})` }}>
      {/* Navbar */}
      ...
      <div className="flex items-center justify-center min-h-screen px-4 py-8">
        <div className="bg-white bg-opacity-80 p-8 rounded-lg shadow-lg max-w-sm w-full">
          <img src={Wealthwise} alt="Wealthwise Logo" className="mx-auto mb-6 w-30" />
          <form onSubmit={handleSubmit}>
            <h1 className="text-2xl font-bold text-center text-purple-600 mb-4">Login</h1>
            <div className="mb-4">
